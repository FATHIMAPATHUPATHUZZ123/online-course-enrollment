...
$result = $conn->query("
    SELECT c.id, c.title, c.duration, c.created_at, c.status, i.name AS instructor_name
    FROM courses c
...
<form method="post" action="delete_inactive_courses.php" onsubmit="return confirm('Delete all inactive courses?');">
<button type="submit">Delete Inactive Courses</button>
</form>
...
<td><?php echo htmlspecialchars(!empty($row['instructor_name'])?$row['instructor_name']:'No Instructor'); ?></td>
<td><?php echo htmlspecialchars($row['duration']); ?></td>
<td><?php echo $row['created_at']; ?></td>
<td><?php echo $row['status']; ?></td>
<td>
<a href="edit_course.php?id=<?php echo $row['id']; ?>">Edit</a>
<a href="view_courses.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Delete this course?')">Delete</a>
</td>
</tr>
<?php endwhile; ?>
</tbody>
