...
$stmt = $conn->prepare("SELECT id, name, email, status FROM instructors WHERE id=?");
...
if($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $stmt = $conn->prepare("UPDATE instructors SET name=?, email=?, status=? WHERE id=?");
...
<p><a href="view_instructors.php">← Back to Instructors</a></p>
</body>
</html>
